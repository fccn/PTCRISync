 ...
 * @see ORCIDWorker
 */
public final class ORCIDGetWorker2 extends ORCIDWorker {

	private final FundingSummary work;
	 ...
	 */
	public ORCIDGetWorker2(FundingSummary work, ORCIDClient client, Map<BigInteger, PTCRISyncResult> cb, Logger log)
	...
	public void run() {
		...
		final PTCRISyncResult fullWork = client.getFunding(work);
